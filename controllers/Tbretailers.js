...
let getuser = function (req, res){
    let sqlquery = "SELECT * FROM retailers";
...
let adduser = function (req, res) {
    let sqlquery1 = "INSERT INTO retailers SET?";
...
let updateUser = function (req, res) {
    ...
    let sql = 'UPDATE retailers SET? WHERE retailers_id =?';
...
let deleteuser = function(req, res){
    ...
    let sqlquery = "DELETE FROM retailers WHERE retailers_id=?";
